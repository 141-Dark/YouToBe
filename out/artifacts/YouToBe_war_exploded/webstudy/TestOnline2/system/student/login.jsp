...
<html>
	<head>
		...
		<script type="text/javascript" src="webstudy/TestOnline2/js/jquery-1.9.1.min.js"></script>
		<script type="text/javascript" src="webstudy/TestOnline2/js/login.js" ></script>
		<script type="text/javascript" src="webstudy/TestOnline2/js/check.js" ></script>
		<link href="webstudy/TestOnline2/css/login.css" rel="stylesheet" type="text/css" />
