...
<div class="container">
    <div class="row">
        ...
        <form id="form1" method="post" title="form1" name="form1" class="bs-example bs-example-form "  onsubmit="checkNull(form1)" action="${pageContext.request.contextPath}/registerServlet">
            ...
            <input type="hidden" name="method" value="stu_login">
            <table class="table-striped" >
                <caption  style="text-align:center"><h1>学生登录</h1></caption>
                <tr style="margin-bottom:10px;">
                    <td><input type="text" name="cname" id="ID"  title="账号" ID="TextBox1" class="form-control control-label ID" Width="241px"  placeholder="输入用户名" OnTextChanged="TextBox1_TextChanged" ></td>
                </tr>

                <tr>
                    <td>
                        <input type="password" name="cellphone" ID="TextBox2" title="密码" class="form-control"  Width="241px" placeholder="输入手机号">
                    </td>
                </tr>
                <tr>
                    <td>
